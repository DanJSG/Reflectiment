...
model.fit(x=x_train_padded, y=y_train, batch_size=32, epochs=60, verbose=1, shuffle=True, validation_data=(x_validation_padded, y_validation), callbacks=[tb_callback, model_checkpoint_callback])
