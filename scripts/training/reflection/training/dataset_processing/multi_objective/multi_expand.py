...
file = open("./dataset_processing/combined/multi_objective/sentences.train.txt", "r", encoding="utf8")
scores_file = open("./dataset_processing/combined/multi_objective/scores.train.txt", "r")
...
out_scores_file = open("./datasets/multi_extended/scores.train.txt", "w+")
out_sentences_file = open("./datasets/multi_extended/sentences.train.txt", "w+", encoding="utf8")
