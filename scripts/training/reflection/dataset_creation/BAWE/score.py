...
if os.path.isfile("./BAWE/progress.txt"):
    progress_file = open("./BAWE/progress.txt", "r")
    start_pos = int(progress_file.readlines()[0])
else:
    start_pos = 0

sentences_file = open("./BAWE/sentences/sentences.txt", "r", encoding='utf8')
score_file = open("./BAWE/scores.txt", "a+")
...
progress_file = open("./BAWE/progress.txt", "w+")
