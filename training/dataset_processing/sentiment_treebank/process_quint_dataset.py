...
def main():
    ...
    train_x_file = open("./processed_datasets/train_x.txt", "w+")
    train_y_file = open("./processed_datasets/train_y.txt", "w+")
    validation_x_file = open("./processed_datasets/validation_x.txt", "w+")
    validation_y_file = open("./processed_datasets/validation_y.txt", "w+")
