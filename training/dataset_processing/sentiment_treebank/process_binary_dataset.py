...
def main():
    ...
    train_x_file = open("./processed_datasets/binary_train_x.txt", "w+")
    train_y_file = open("./processed_datasets/binary_train_y.txt", "w+")
    validation_x_file = open("./processed_datasets/binary_validation_x.txt", "w+")
    validation_y_file = open("./processed_datasets/binary_validation_y.txt", "w+")
