...
public final class StopWords {
    ...
    private static final String[] STOP_WORD_ARRAY = new String[]{"a's", "able", "about", "above", "according", "accordingly",
            ...
            "keeps", "kept", "know", "known", "knows", "last", "lately", "later", "latter", "latterly", "least", "less",
            ...
            "soon", "sorry", "specified", "specify", "specifying", "still", "sub", "such", "sup", "sure", "t's", "take",
    ...
    static {
        for(String stopWord : STOP_WORD_ARRAY){
            STOP_WORD_MAP.put(stopWord, true);
        }
    }
    ...
    public static boolean isStopWord(String word) {
        return STOP_WORD_MAP.containsKey(word);
    }
